...
const page = ({ params }: { params: Promise<{ invoiceId: string }> }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error("Erreur Sauvegarde de la facture :", error);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    if (confirmed) {
      try {
        ...
        console.error("Erreur de Suppression de la facture.", error);
      }
    }
  };
    ...
    <Wrapper>
      <div>
        <div className='flex flex-col md:flex-row md:justify-between md:items-center mb-4'>
          ...
          <p className='badge badge-ghost badge-lg p-4 uppercase'>
            <span className='font-bold'>Facture ➡️</span> {invoice?.id}
          </p>
          ...
          <div className='flex  w-full md:w-1/3 flex-col'>
            <div className='mb-4 bg-base-200 rounded-xl p-5'>
              ...
              <div className='flex justify-between items-center mb-4 '>
                <div className='badge badge-accent p-4'>Synthèse Total</div>
