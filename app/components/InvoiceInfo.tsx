    ...
    return (
        <div className='flex flex-col h-fit bg-base-200 p-5 rounded-xl mb-4 md:mb-0'>
            <div className='space-y-4'>
                <h2 className='badge badge-accent p-4'>Émetteur</h2>
                <input
                    type="text"
                ...
                <h2 className='badge badge-accent p-4'>Client</h2>
                <input
                    type="text"
                ...
                <h2 className='badge badge-accent p-4'>Date de la Facture</h2>
                <input
                    type="date"
                ...
                <h2 className='badge badge-accent p-4'>Date d'échéance</h2>
                <input
                    type="date"
